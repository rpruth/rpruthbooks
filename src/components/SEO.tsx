...
export default function SEO({ meta }: SEOProps) {
  useEffect(() => {
    ...
    const metaTags = [
      ...
      { selector: 'meta[name="author"]', attributes: { name: 'author', content: 'R.P. Ruth' } },
      ...
      { selector: 'meta[property="og:site_name"]', attributes: { property: 'og:site_name', content: 'R.P. Ruth - Author' } },
